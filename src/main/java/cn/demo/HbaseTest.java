...
//        System.setProperty("java.security.krb5.kdc","132.121.98.74");
        ...
        System.setProperty("java.security.krb5.conf","D:/krb5.conf");//windows 环境可以将此文件改成krb5.ini放到C:/Windows目录下；Linux环境放到/etc/文件下，改成krb5.sh文件，系统会自动加载
        ...
        try{
            UserGroupInformation.loginUserFromKeytab("itmp/132.121.109.86@ECLD.COM","D:/itmp.132.121.109.86.keytab");//认证用户部分
        }catch(IOException e) {
        ...
        System.out.println("输出connection："+connection);
